...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ObjectModelClient.TFS.Client.Channels.ITfsRequestChannelWrapper instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ObjectModelClient.TFS.Client.Channels.ITfsRequestChannelWrapper GetInstance() 
  { 
    var real = default(Microsoft.TeamFoundation.Client.Channels.ITfsRequestChannel);
    RealInstanceFactory(ref real);
    var instance = (DynCon.OSI.VSO.ObjectModelClient.TFS.Client.Channels.ITfsRequestChannelWrapper) DynCon.OSI.VSO.ObjectModelClient.TFS.Client.Channels.ITfsRequestChannelWrapper.GetWrapper(real);
    InstanceFactory(ref instance);
    if (instance == null) Assert.Inconclusive("Could not Create Test Instance");
    return instance;
  }

  static partial void RealInstanceFactory(ref Microsoft.TeamFoundation.Client.Channels.ITfsRequestChannel real, [CallerMemberName]string callerName = "");
  internal static IEnumerable<DynCon.OSI.VSO.ObjectModelClient.TFS.Client.Channels.ITfsRequestChannelWrapper> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ObjectModelClient.TFS.Client.Channels.ITfsRequestChannelWrapper>{ GetInstance() }; }
  ...
  public void BeginRequest_UnitTest()
  {
    ...
    System.Object state = default(System.Object);
      ExecuteMethod(
        ...
        (instance) =>
        {
          message = DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.Client.Channels.TfsMessageWrapper_UnitTests.GetInstance();
