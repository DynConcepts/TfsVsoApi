...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.TeamFoundationIdentityWrapper instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.TeamFoundationIdentityWrapper GetInstance() 
  { 
    var real = default(Microsoft.TeamFoundation.Framework.Client.TeamFoundationIdentity);
    RealInstanceFactory(ref real);
    var instance = (DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.TeamFoundationIdentityWrapper) DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.TeamFoundationIdentityWrapper.GetWrapper(real);
    InstanceFactory(ref instance);
    if (instance == null) Assert.Inconclusive("Could not Create Test Instance");
    return instance;
  }

  static partial void RealInstanceFactory(ref Microsoft.TeamFoundation.Framework.Client.TeamFoundationIdentity real, [CallerMemberName]string callerName = "");
  internal static IEnumerable<DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.TeamFoundationIdentityWrapper> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.TeamFoundationIdentityWrapper>{ GetInstance() }; }
