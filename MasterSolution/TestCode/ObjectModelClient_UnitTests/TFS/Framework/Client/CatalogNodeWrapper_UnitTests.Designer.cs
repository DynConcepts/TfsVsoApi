...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.CatalogNodeWrapper instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.CatalogNodeWrapper GetInstance() 
  { 
    var real = default(Microsoft.TeamFoundation.Framework.Client.CatalogNode);
    RealInstanceFactory(ref real);
    var instance = (DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.CatalogNodeWrapper) DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.CatalogNodeWrapper.GetWrapper(real);
    InstanceFactory(ref instance);
    if (instance == null) Assert.Inconclusive("Could not Create Test Instance");
    return instance;
  }

  static partial void RealInstanceFactory(ref Microsoft.TeamFoundation.Framework.Client.CatalogNode real, [CallerMemberName]string callerName = "");
  internal static IEnumerable<DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.CatalogNodeWrapper> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.CatalogNodeWrapper>{ GetInstance() }; }
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Common.ICatalogQueryOptions queryOptions = default(DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Common.ICatalogQueryOptions);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          queryOptions = DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.Framework.Common.CatalogQueryOptionsWrapper_UnitTests.GetInstance();
