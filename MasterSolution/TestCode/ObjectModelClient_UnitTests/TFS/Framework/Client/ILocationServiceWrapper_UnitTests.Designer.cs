...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.ILocationServiceWrapper instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.ILocationServiceWrapper GetInstance() 
  { 
    var real = default(Microsoft.TeamFoundation.Framework.Client.ILocationService);
    RealInstanceFactory(ref real);
    var instance = (DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.ILocationServiceWrapper) DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.ILocationServiceWrapper.GetWrapper(real);
    InstanceFactory(ref instance);
    if (instance == null) Assert.Inconclusive("Could not Create Test Instance");
    return instance;
  }

  static partial void RealInstanceFactory(ref Microsoft.TeamFoundation.Framework.Client.ILocationService real, [CallerMemberName]string callerName = "");
  internal static IEnumerable<DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.ILocationServiceWrapper> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ObjectModelClient.TFS.Framework.Client.ILocationServiceWrapper>{ GetInstance() }; }
  ...
  public void SaveServiceDefinition_UnitTest()
  {
    DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Client.IServiceDefinition serviceDefinition = default(DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Client.IServiceDefinition);
      ExecuteMethod(
        ...
        (instance) =>
        {
          serviceDefinition = DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.Framework.Client.ServiceDefinitionWrapper_UnitTests.GetInstance();
  ...
  public void SaveServiceDefinitions_UnitTest()
  {
    System.Collections.Generic.IEnumerable<DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Client.IServiceDefinition> serviceDefinitions = default(System.Collections.Generic.IEnumerable<DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Client.IServiceDefinition>);
      ExecuteMethod(
        ...
        (instance) =>
        {
          serviceDefinitions = DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.Framework.Client.ServiceDefinitionWrapper_UnitTests.GetIEnumerableInstance();
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Client.IAccessMapping accessMapping = default(DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Client.IAccessMapping);
      ExecuteMethod(
        ...
        (instance) =>
        {
          serviceType = default(System.String); //No Constructor
          serviceIdentifier = default(System.Guid); //No Constructor
          accessMapping = DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.Framework.Client.AccessMappingWrapper_UnitTests.GetInstance();
