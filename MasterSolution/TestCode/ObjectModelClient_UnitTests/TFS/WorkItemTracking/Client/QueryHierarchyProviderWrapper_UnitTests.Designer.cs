...
namespace DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.WorkItemTracking.Client
{
    ...
    public partial class QueryHierarchyProviderWrapper_UnitTests : DynTestClassBase
    {
        ...
        public void InvalidateAllHierarchies_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQueryHierarchyProvider) GetInstance(); },
                instance => { InvalidateAllHierarchies_PreCondition(ref instance); },
        ...
        partial void GetAccessControlListMetadata_PreCondition(ref IQueryHierarchyProvider instance, ref String objectClassId);
        ...
        partial void GetQueryDefinition_PreCondition(ref IQueryHierarchyProvider instance, ref Guid id);
        partial void GetQueryHierarchy_PostValidate(IQueryHierarchyProvider instance, IProject project);
        partial void GetQueryHierarchy_PreCondition(ref IQueryHierarchyProvider instance, ref IProject project);
        ...
        partial void InvalidateAllHierarchies_PreCondition(ref IQueryHierarchyProvider instance);
        partial void IsQueryHierarchyReady_PostValidate(IQueryHierarchyProvider instance, IProject project);
        partial void IsQueryHierarchyReady_PreCondition(ref IQueryHierarchyProvider instance, ref IProject project);
