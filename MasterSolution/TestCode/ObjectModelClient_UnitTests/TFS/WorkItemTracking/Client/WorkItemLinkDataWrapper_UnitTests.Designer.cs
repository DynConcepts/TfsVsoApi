...
using DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.WorkItemTracking.Internals;
...
namespace DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.WorkItemTracking.Client
{
    ...
    public partial class WorkItemLinkDataWrapper_UnitTests : DynTestClassBase
    {
        ...
        internal static IEnumerable<WorkItemLinkDataWrapper> GetIEnumerableInstance() { return new List<WorkItemLinkDataWrapper> {GetInstance()}; }

        internal static WorkItemLinkDataWrapper GetInstance()
        {
            WorkItemLinkData real = default(WorkItemLinkData);
            RealInstanceFactory(ref real);
            var instance = (WorkItemLinkDataWrapper) WorkItemLinkDataWrapper.GetWrapper(real);
        ...
        static partial void InstanceFactory(ref WorkItemLinkDataWrapper instance, [CallerMemberName] string callerName = "");
        ...
        static partial void RealInstanceFactory(ref WorkItemLinkData real, [CallerMemberName] string callerName = "");
