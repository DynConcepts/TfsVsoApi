    ...
    public partial class TfsMessageWrapper_UnitTests : DynTestClassBase
    {
        ...
        public void CreateException_UnitTest()
        {
            ExecuteMethod(
                ...
                instance => { CreateException_PreCondition(instance); },
        ...
        public void GetBodyReader_UnitTest()
        {
            ExecuteMethod(
                () => { return (ITfsMessage) GetInstance(); },
                instance => { GetBodyReader_PreCondition(instance); },
        ...
        internal static IEnumerable<TfsMessageWrapper> GetIEnumerableInstance() { return new List<TfsMessageWrapper> {GetInstance()}; }
