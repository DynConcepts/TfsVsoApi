    ...
    public partial class FieldDefinitionWrapper_UnitTests : DynTestClassBase
    {
        ...
        public void FilteredAllowedValues_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    filters = FieldFilterListWrapper_UnitTests.GetInstance();
                    FilteredAllowedValues_PreCondition(instance, ref filters);
                },
        ...
        internal static IEnumerable<FieldDefinitionWrapper> GetIEnumerableInstance() { return new List<FieldDefinitionWrapper> {GetInstance()}; }

        internal static FieldDefinitionWrapper GetInstance()
        {
            FieldDefinition real = default(FieldDefinition);
            RealInstanceFactory(ref real);
            var instance = (FieldDefinitionWrapper) FieldDefinitionWrapper.GetWrapper(real);
        ...
        static partial void InstanceFactory(ref FieldDefinitionWrapper instance, [CallerMemberName] string callerName = "");
        ...
        static partial void RealInstanceFactory(ref FieldDefinition real, [CallerMemberName] string callerName = "");
