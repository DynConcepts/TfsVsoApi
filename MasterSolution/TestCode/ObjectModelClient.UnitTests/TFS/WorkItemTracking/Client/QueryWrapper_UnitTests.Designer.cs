...
namespace DynCon.OSI.VSO.ObjectModelClient_UnitTests.TFS.WorkItemTracking.Client
{
    ...
    [TestClass]
    public partial class QueryWrapper_UnitTests : DynTestClassBase
    {
        /// <summary>Generated Test Template</summary>
        [TestMethod]
        ...
        public void BeginCountOnlyQuery_UnitTest()
        {
            ExecuteMethod(
                ...
                instance => { BeginCountOnlyQuery_PreCondition(instance); },
        ...
        public void BeginLinkQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { BeginLinkQuery_PreCondition(instance); },
        ...
        public void BeginQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { BeginQuery_PreCondition(instance); },
        ...
        public void BeginRegularQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { BeginRegularQuery_PreCondition(instance); },
        ...
        public void EndCountOnlyQuery_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    EndCountOnlyQuery_PreCondition(instance, ref car);
                },
        ...
        public void EndLinkQuery_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                {
                    car = ICancelableAsyncResultWrapper_UnitTests.GetInstance();
                    EndLinkQuery_PreCondition(instance, ref car);
                },
        ...
        public void EndQuery_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                {
                    car = ICancelableAsyncResultWrapper_UnitTests.GetInstance();
                    EndQuery_PreCondition(instance, ref car);
                },
        ...
        public void GetLinkTypes_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { GetLinkTypes_PreCondition(instance); },
        ...
        public void RunCountQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { RunCountQuery_PreCondition(instance); },
        ...
        public void RunLinkQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { RunLinkQuery_PreCondition(instance); },
        ...
        public void RunQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { RunQuery_PreCondition(instance); },
        ...
        public void RunRegularQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { RunRegularQuery_PreCondition(instance); },
        ...
        public void RunRevisionQuery_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQuery) GetInstance(); },
                instance => { RunRevisionQuery_PreCondition(instance); },
        ...
        partial void EndLinkQuery_PreCondition(IQuery instance, ref IICancelableAsyncResult car);
        ...
        internal static IEnumerable<QueryWrapper> GetIEnumerableInstance() { return new List<QueryWrapper> {GetInstance()}; }

        internal static QueryWrapper GetInstance([CallerMemberName] string callerName = "")
        {
            Query real = default(Query);
            RealInstanceFactory(ref real);
            var instance = (QueryWrapper) QueryWrapper.GetWrapper(real);
        ...
        partial void GetLinkTypes_PreCondition(IQuery instance);
        static partial void InstanceFactory(ref QueryWrapper instance, [CallerMemberName] string callerName = "");
        ...
        static partial void RealInstanceFactory(ref Query real, [CallerMemberName] string callerName = "");
        partial void RunCountQuery_PostValidate(IQuery instance);
        partial void RunCountQuery_PreCondition(IQuery instance);
        partial void RunLinkQuery_PostValidate(IQuery instance);
        partial void RunLinkQuery_PreCondition(IQuery instance);
        partial void RunQuery_PostValidate(IQuery instance);
        partial void RunQuery_PreCondition(IQuery instance);
        partial void RunRegularQuery_PostValidate(IQuery instance);
        partial void RunRegularQuery_PreCondition(IQuery instance);
        partial void RunRevisionQuery_PostValidate(IQuery instance);
        partial void RunRevisionQuery_PreCondition(IQuery instance);
