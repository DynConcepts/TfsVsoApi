...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.APIs
{
    ...
    public partial class TFSVersionControlAPI_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(ref TFSVersionControlAPI instance, ref Object obj);

        partial void GetHashCode_PostValidate(TFSVersionControlAPI instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(ref TFSVersionControlAPI instance);
        ...
        partial void GetType_PreCondition(ref TFSVersionControlAPI instance);
        ...
        partial void ToString_PreCondition(ref TFSVersionControlAPI instance);
    }
}