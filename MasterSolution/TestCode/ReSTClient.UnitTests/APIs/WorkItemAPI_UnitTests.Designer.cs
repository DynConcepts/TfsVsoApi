...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.APIs
{
    ...
    public partial class WorkItemAPI_UnitTests : DynTestClassBase
    {
        ...
        public void BuildWorkItem_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    BuildWorkItem_PreCondition(ref instance, ref projectName, ref workItemType, ref fieldValues);
                },
                instance => { _retVal = instance.BuildWorkItem(projectName, workItemType, fieldValues); },
        ...
        public void CreateWorkItem_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    CreateWorkItem_PreCondition(ref instance, ref project, ref workItem);
                },
                instance => { _retVal = instance.CreateWorkItem(project, workItem); },
        ...
        partial void CreateWorkItem_PreCondition(ref WorkItemAPI instance, ref String project, ref IWorkItem workItem);

        partial void Equals_PostValidate(WorkItemAPI instance, Object obj, Boolean _retVal);
        partial void Equals_PreCondition(ref WorkItemAPI instance, ref Object obj);
        partial void GetAreas_PostValidate(WorkItemAPI instance, String project, Int32 depth, Task<IReadOnlyList<IArea>> _retVal);
        partial void GetAreas_PreCondition(ref WorkItemAPI instance, ref String project, ref Int32 depth);
        partial void GetFieldDefinitions_PostValidate(WorkItemAPI instance, Task<IReadOnlyList<IFieldDefinition>> _retVal);
        partial void GetFieldDefinitions_PreCondition(ref WorkItemAPI instance);

        partial void GetHashCode_PostValidate(WorkItemAPI instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(ref WorkItemAPI instance);
        ...
        partial void GetIterations_PreCondition(ref WorkItemAPI instance, ref String project, ref Int32 depth);
        partial void GetLinksForWorkItem_PostValidate(WorkItemAPI instance, IWorkItem workItem, Task<ILinkCollection> _retVal);
        partial void GetLinksForWorkItem_PreCondition(ref WorkItemAPI instance, ref IWorkItem workItem);
        partial void GetRelationTypes_PostValidate(WorkItemAPI instance, Task<IReadOnlyList<IRelationType>> _retVal);
        partial void GetRelationTypes_PreCondition(ref WorkItemAPI instance);

        partial void GetType_PostValidate(WorkItemAPI instance, Type _retVal);
        partial void GetType_PreCondition(ref WorkItemAPI instance);
        ...
        partial void GetWorkItemTypeCategories_PreCondition(ref WorkItemAPI instance, ref String project);
        ...
        partial void GetWorkItemTypes_PreCondition(ref WorkItemAPI instance, ref String project);
        partial void GetWorkItems_PostValidate(WorkItemAPI instance, IEnumerable<Int32> ids, Task<IReadOnlyList<IWorkItem>> _retVal);
        partial void GetWorkItems_PreCondition(ref WorkItemAPI instance, ref IEnumerable<Int32> ids);
        ...
        partial void ToString_PreCondition(ref WorkItemAPI instance);
        ...
        partial void WiqlQuery_PreCondition(ref WorkItemAPI instance, ref String wiql, ref Boolean fullyPopulate);
    }
}