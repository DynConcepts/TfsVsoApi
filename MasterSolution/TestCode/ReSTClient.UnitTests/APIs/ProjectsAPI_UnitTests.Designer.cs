...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.APIs
{
    ...
    public partial class ProjectsAPI_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(ref ProjectsAPI instance, ref Object obj);

        partial void GetHashCode_PostValidate(ProjectsAPI instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(ref ProjectsAPI instance);
        ...
        partial void GetProjects_PreCondition(ref ProjectsAPI instance);

        partial void GetType_PostValidate(ProjectsAPI instance, Type _retVal);
        partial void GetType_PreCondition(ref ProjectsAPI instance);
        ...
        partial void ToString_PreCondition(ref ProjectsAPI instance);
    }
}