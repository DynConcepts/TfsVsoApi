...
namespace DynCon.OSI.VSO.ReSTClient.LowLevelAPIs
{
    ...
    public partial class JsonCoreAPI_UnitTests : DynTestClassBase
    {
        ...
        partial void GetProjects_PostValidate(JsonCoreAPI instance, Task<IReadOnlyList<JsonGeneralPurposeObject>> _retVal) { _retVal.Wait(); }
        partial void GetProxies_PostValidate(JsonCoreAPI instance, Task<IReadOnlyList<JsonGeneralPurposeObject>> _retVal) { _retVal.Wait(); }
