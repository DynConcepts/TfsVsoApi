...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Common
{
    ...
    public partial class ReadOnlyListImpl_UnitTests : DynTestClassBase
    {
        ...
        partial void CopyTo_PreCondition(ref IReadOnlyList instance, ref Array array, ref Int32 index);
        ...
        partial void GetEnumerator_PreCondition(ref IReadOnlyList instance);
