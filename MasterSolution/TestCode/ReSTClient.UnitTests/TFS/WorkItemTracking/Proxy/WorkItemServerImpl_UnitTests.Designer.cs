...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Proxy.WorkItemServerImpl instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Proxy.WorkItemServerImpl GetInstance([CallerMemberName]string callerName = "") 
  { 
    var instance = new DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Proxy.WorkItemServerImpl();
    InstanceFactory(ref instance, callerName);
    return  instance;
  }

  internal static IEnumerable<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Proxy.WorkItemServerImpl> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Proxy.WorkItemServerImpl>{ GetInstance() }; }
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets metadata = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          workItem = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.IWorkItemRowSetsImpl_UnitTests.GetInstance();
          metadataHave = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IMetadataTableHaveEntry)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.MetadataTableHaveEntryImpl_UnitTests.GetInstance()};
          dbStamp = default(System.String); //No Constructor
          metadata = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.IMetadataRowSetsImpl_UnitTests.GetInstance();
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets metadata = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          sort = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IQuerySortOrderEntry)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.QuerySortOrderEntryImpl_UnitTests.GetInstance()};
          useMaster = default(System.Boolean); //No Constructor
          pairs = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIdRevisionPair)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.IdRevisionPairImpl_UnitTests.GetInstance()};
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets metadata = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          sort = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IQuerySortOrderEntry)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.QuerySortOrderEntryImpl_UnitTests.GetInstance()};
          useMaster = default(System.Boolean); //No Constructor
          relations = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IWorkItemRelation)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.WorkItemRelationImpl_UnitTests.GetInstance()};
          asOfDate = default(System.DateTime); //No Constructor
          metadataHave = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IMetadataTableHaveEntry)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.MetadataTableHaveEntryImpl_UnitTests.GetInstance()};
          dbStamp = default(System.String); //No Constructor
          metadata = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.IMetadataRowSetsImpl_UnitTests.GetInstance();
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets metadata = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IIMetadataRowSets);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          asOfDate = default(System.Nullable<System.DateTime>); //No Type
          useMaster = default(System.Boolean); //No Constructor
          items = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.IPagedItemsRowSetsImpl_UnitTests.GetInstance();
          metadataHave = new [] { (DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IMetadataTableHaveEntry)DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.MetadataTableHaveEntryImpl_UnitTests.GetInstance()};
          metadata = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.IMetadataRowSetsImpl_UnitTests.GetInstance();
  ...
  public void UploadFile_UnitTest()
  {
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IFileAttachment fileAttachment = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IFileAttachment);
      ExecuteMethod(
        ...
        (instance) =>
        {
          fileAttachment = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.FileAttachmentImpl_UnitTests.GetInstance();
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IRowSetCollection queryDataSet = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IRowSetCollection);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          queryDataSet = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.RowSetCollectionImpl_UnitTests.GetInstance();
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IRowSetCollection queriesDataSet = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Proxy.IRowSetCollection);
      ExecuteMethod(
        ...
        (instance) =>
        {
          ...
          queriesDataSet = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Proxy.RowSetCollectionImpl_UnitTests.GetInstance();
