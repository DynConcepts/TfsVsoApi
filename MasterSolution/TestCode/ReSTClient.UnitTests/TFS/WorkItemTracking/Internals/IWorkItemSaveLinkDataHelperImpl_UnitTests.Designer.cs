...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Internals
{
    ...
    public partial class IWorkItemSaveLinkDataHelperImpl_UnitTests : DynTestClassBase
    {
        ...
        public void ResetWorkItemLinkInfo_UnitTest()
        {
            ExecuteMethod(
                () => { return (IIWorkItemSaveLinkDataHelper) GetInstance(); },
                instance => { ResetWorkItemLinkInfo_PreCondition(ref instance); },
        ...
        partial void AddWorkItemLinkInfo_PreCondition(ref IIWorkItemSaveLinkDataHelper instance, ref IWorkItemLinkInfo link);
        ...
        partial void ResetWorkItemLinkInfo_PreCondition(ref IIWorkItemSaveLinkDataHelper instance);
