...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client
{
    ...
    public partial class WorkItemTypeImpl_UnitTests : DynTestClassBase
    {
        ...
        public void NewWorkItem_UnitTest()
        {
            ExecuteMethod(
                () => { return (IWorkItemType) GetInstance(); },
                instance => { NewWorkItem_PreCondition(ref instance); },
        ...
        partial void Export_PreCondition(ref IWorkItemType instance, ref Boolean includeGlobalListsFlag);
        ...
        partial void GetNextState_PreCondition(ref IWorkItemType instance, ref String currentState, ref String action);
        ...
        partial void NewWorkItem_PreCondition(ref IWorkItemType instance);
