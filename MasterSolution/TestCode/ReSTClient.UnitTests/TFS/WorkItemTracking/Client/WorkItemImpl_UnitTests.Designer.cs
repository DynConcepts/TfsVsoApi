    ...
    public partial class WorkItemImpl_UnitTests : DynTestClassBase
    {
        ...
        public void Copy_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    targetType = WorkItemTypeImpl_UnitTests.GetInstance();
                    flags = WorkItemCopyFlagsImpl_UnitTests.GetInstance();
        ...
        public void GetActionObject_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    actionInfo = WorkItem_EditActionInfoImpl_UnitTests.GetInstance();
        ...
        public void GetActionsHistory_UnitTest()
        {
            ExecuteMethod(
                () => { return (IWorkItem) GetInstance(); },
                instance => { GetActionsHistory_PreCondition(ref instance); },
        ...
        public void GetFieldValueExternal_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    fd = FieldDefinitionImpl_UnitTests.GetInstance();
        ...
        public void GetLatestSyncData_UnitTest()
        {
            ExecuteMethod(
                () => { return (IWorkItem) GetInstance(); },
                instance => { GetLatestSyncData_PreCondition(ref instance); },
        ...
        public void Open_UnitTest()
        {
            ExecuteMethod(
                () => { return (IWorkItem) GetInstance(); },
                instance => { Open_PreCondition(ref instance); },
        ...
        public void PartialOpen_UnitTest()
        {
            ExecuteMethod(
                () => { return (IWorkItem) GetInstance(); },
                instance => { PartialOpen_PreCondition(ref instance); },
        ...
        public void SyncToLatest_UnitTest()
        {
            ExecuteMethod(
                () => { return (IWorkItem) GetInstance(); },
                instance => { SyncToLatest_PreCondition(ref instance); },
        ...
        public void SyncWorkItem_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    syncData = WorkItemSyncDataImpl_UnitTests.GetInstance();
        ...
        partial void ApplyRules_PreCondition(ref IWorkItem instance, ref Boolean copyChangedByFromLatest);
        ...
        partial void CalculateFieldLists_PreCondition(ref IWorkItem instance, ref Int32 fieldId);
        ...
        partial void Copy_PreCondition(ref IWorkItem instance, ref IWorkItemType targetType, ref IWorkItemCopyFlags flags);
        ...
        partial void GetActionObject_PreCondition(ref IWorkItem instance, ref IWorkItem_EditActionInfo actionInfo);
        partial void GetActionsHistory_PostValidate(IWorkItem instance);
        partial void GetActionsHistory_PreCondition(ref IWorkItem instance);
        partial void GetFieldValueExternal_PostValidate(IWorkItem instance, IFieldDefinition fd, Int32 revision);
        partial void GetFieldValueExternal_PreCondition(ref IWorkItem instance, ref IFieldDefinition fd, ref Int32 revision);
        partial void GetFieldValue_PostValidate(IWorkItem instance, Int32 id, Int32 revision);
        partial void GetFieldValue_PreCondition(ref IWorkItem instance, ref Int32 id, ref Int32 revision);
        internal static IEnumerable<WorkItemImpl> GetIEnumerableInstance() { return new List<WorkItemImpl> {GetInstance()}; }
        ...
        partial void GetLatestSyncData_PreCondition(ref IWorkItem instance);
        ...
        partial void Open_PreCondition(ref IWorkItem instance);
        partial void PartialOpen_PostValidate(IWorkItem instance);
        partial void PartialOpen_PreCondition(ref IWorkItem instance);
        ...
        partial void SetDirty_PreCondition(ref IWorkItem instance, ref Boolean isDirty);
        partial void SyncToLatest_PostValidate(IWorkItem instance);
        partial void SyncToLatest_PreCondition(ref IWorkItem instance);
        partial void SyncWorkItem_PostValidate(IWorkItem instance, IWorkItemSyncData syncData);
        partial void SyncWorkItem_PreCondition(ref IWorkItem instance, ref IWorkItemSyncData syncData);
...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client
{
    ...
    {
        internal static IEnumerable<WorkItem_EditActionSetImpl> GetIEnumerableInstance() { return new List<WorkItem_EditActionSetImpl> {GetInstance()}; }

        internal static WorkItem_EditActionSetImpl GetInstance([CallerMemberName] string callerName = "")
        {
            WorkItem_EditActionSetImpl instance = default(WorkItem_EditActionSetImpl);
            InstanceFactory(ref instance, callerName);
            return instance;
        }

        static partial void InstanceFactory(ref WorkItem_EditActionSetImpl instance, [CallerMemberName] string callerName = "");
    }
}
...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client
{
    ...
    {
        internal static IEnumerable<WorkItem_EditActionInfoImpl> GetIEnumerableInstance() { return new List<WorkItem_EditActionInfoImpl> {GetInstance()}; }

        internal static WorkItem_EditActionInfoImpl GetInstance([CallerMemberName] string callerName = "")
        {
            WorkItem_EditActionInfoImpl instance = default(WorkItem_EditActionInfoImpl);
            InstanceFactory(ref instance, callerName);
            return instance;
        }

        static partial void InstanceFactory(ref WorkItem_EditActionInfoImpl instance, [CallerMemberName] string callerName = "");
    }
}