...
/// <summary>Generated Test Template</summary>
  [TestClass]
  public partial class WorkItemImpl_UnitTests : DynTestClassBase 
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItemImpl instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItemImpl GetInstance([CallerMemberName]string callerName = "") 
  { 
    JToken json = new JObject();
    JsonSource(ref json);
    var instance = (DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItemImpl) DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItemImpl.FromToken(json);
    InstanceFactory(ref instance, callerName);
    return  instance;
  }

  static partial void JsonSource(ref JToken json);
  internal static IEnumerable<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItemImpl> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItemImpl>{ GetInstance() }; }
  ...
  public void GetFieldValueExternal_UnitTest()
  {
    ...
    System.Int32 revision = default(System.Int32);
      ExecuteMethod(
        ...
        (instance) =>
        {
          fd = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client.FieldDefinitionImpl_UnitTests.GetInstance();
  ...
  public void Copy_UnitTest()
  {
    ...
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Client.IWorkItemCopyFlags flags = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Client.IWorkItemCopyFlags);
      ExecuteMethod(
        ...
        (instance) =>
        {
          targetType = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client.WorkItemTypeImpl_UnitTests.GetInstance();
          flags = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client.WorkItemCopyFlagsImpl_UnitTests.GetInstance();
  ...
  public void SyncWorkItem_UnitTest()
  {
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Client.IWorkItemSyncData syncData = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Client.IWorkItemSyncData);
      ExecuteMethod(
        ...
        (instance) =>
        {
          syncData = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client.WorkItemSyncDataImpl_UnitTests.GetInstance();
  ...
  public void GetActionObject_UnitTest()
  {
    DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Client.IWorkItem_EditActionInfo actionInfo = default(DynCon.OSI.VSO.SharedInterfaces.TFS.WorkItemTracking.Client.IWorkItem_EditActionInfo);
      ExecuteMethod(
        ...
        (instance) =>
        {
          actionInfo = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.WorkItemTracking.Client.WorkItem_EditActionInfoImpl_UnitTests.GetInstance();
...
/// <summary>Generated Test Template</summary>
  [TestClass]
  public partial class WorkItem_EditActionSetImpl_UnitTests : DynTestClassBase 
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionSetImpl instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionSetImpl GetInstance([CallerMemberName]string callerName = "") 
  { 
    var instance = default(DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionSetImpl);
    InstanceFactory(ref instance, callerName);
    return  instance;
  }

  internal static IEnumerable<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionSetImpl> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionSetImpl>{ GetInstance() }; }
...
/// <summary>Generated Test Template</summary>
  [TestClass]
  public partial class WorkItem_EditActionInfoImpl_UnitTests : DynTestClassBase 
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionInfoImpl instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionInfoImpl GetInstance([CallerMemberName]string callerName = "") 
  { 
    var instance = default(DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionInfoImpl);
    InstanceFactory(ref instance, callerName);
    return  instance;
  }

  internal static IEnumerable<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionInfoImpl> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ReSTClient.TFS.WorkItemTracking.Client.WorkItem_EditActionInfoImpl>{ GetInstance() }; }
