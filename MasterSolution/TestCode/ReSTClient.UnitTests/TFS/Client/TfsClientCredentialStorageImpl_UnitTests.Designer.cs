...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ReSTClient.TFS.Client.TfsClientCredentialStorageImpl instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ReSTClient.TFS.Client.TfsClientCredentialStorageImpl GetInstance([CallerMemberName]string callerName = "") 
  { 
    var instance = new DynCon.OSI.VSO.ReSTClient.TFS.Client.TfsClientCredentialStorageImpl();
    InstanceFactory(ref instance, callerName);
    return  instance;
  }

  internal static IEnumerable<DynCon.OSI.VSO.ReSTClient.TFS.Client.TfsClientCredentialStorageImpl> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ReSTClient.TFS.Client.TfsClientCredentialStorageImpl>{ GetInstance() }; }
  ...
  public void StoreToken_UnitTest()
  {
    ...
    System.Boolean matchUserInformation = default(System.Boolean);
      ExecuteMethod(
        ...
        {
          serverUrl = default(System.Uri); //No Type
          token = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.Client.IssuedTokenImpl_UnitTests.GetInstance();
