...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.Client
{
    ...
    public partial class TfsClientCredentialsImpl_UnitTests : DynTestClassBase
    {
        ...
        partial void SignOut_PreCondition(ref ITfsClientCredentials instance, ref Uri serverUrl, ref IIServerDataProvider serverDataProvider);
        partial void TryGetTokenProvider_PostValidate(ITfsClientCredentials instance, Uri serverUrl, IIssuedTokenProvider provider);
        partial void TryGetTokenProvider_PreCondition(ref ITfsClientCredentials instance, ref Uri serverUrl, ref IIssuedTokenProvider provider);
