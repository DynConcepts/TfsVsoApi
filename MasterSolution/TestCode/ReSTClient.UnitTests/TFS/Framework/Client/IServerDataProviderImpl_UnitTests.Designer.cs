...
/// <summary>Generated Test Template</summary>
  ...
  {
  static partial void InstanceFactory(ref DynCon.OSI.VSO.ReSTClient.TFS.Framework.Client.IServerDataProviderImpl instance, [CallerMemberName]string callerName = "");
  internal static DynCon.OSI.VSO.ReSTClient.TFS.Framework.Client.IServerDataProviderImpl GetInstance([CallerMemberName]string callerName = "") 
  { 
    var instance = new DynCon.OSI.VSO.ReSTClient.TFS.Framework.Client.IServerDataProviderImpl();
    InstanceFactory(ref instance, callerName);
    return  instance;
  }

  internal static IEnumerable<DynCon.OSI.VSO.ReSTClient.TFS.Framework.Client.IServerDataProviderImpl> GetIEnumerableInstance() { 
return new List<DynCon.OSI.VSO.ReSTClient.TFS.Framework.Client.IServerDataProviderImpl>{ GetInstance() }; }
  ...
  public void Connect_UnitTest()
  {
    DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Common.IConnectOptions connectOptions = default(DynCon.OSI.VSO.SharedInterfaces.TFS.Framework.Common.IConnectOptions);
      ExecuteMethod(
        ...
        (instance) =>
        {
          connectOptions = DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.Framework.Common.ConnectOptionsImpl_UnitTests.GetInstance();
