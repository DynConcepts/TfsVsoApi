...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.TFS.Framework.Client
{
    ...
    public partial class TeamFoundationIdentityImpl_UnitTests : DynTestClassBase
    {
        ...
        public void GetProperties_UnitTest()
        {
            ExecuteMethod(
                () => { return (ITeamFoundationIdentity) GetInstance(); },
                instance => { GetProperties_PreCondition(ref instance); },
        ...
        partial void GetAttribute_PreCondition(ref ITeamFoundationIdentity instance, ref String name, ref String defaultValue);
        internal static IEnumerable<TeamFoundationIdentityImpl> GetIEnumerableInstance() { return new List<TeamFoundationIdentityImpl> {GetInstance()}; }

        internal static TeamFoundationIdentityImpl GetInstance([CallerMemberName] string callerName = "")
        {
            var instance = new TeamFoundationIdentityImpl();
            InstanceFactory(ref instance, callerName);
            return instance;
        }

        partial void GetProperties_PostValidate(ITeamFoundationIdentity instance);
        partial void GetProperties_PreCondition(ref ITeamFoundationIdentity instance);
        partial void GetProperty_PostValidate(ITeamFoundationIdentity instance, String name);
        partial void GetProperty_PreCondition(ref ITeamFoundationIdentity instance, ref String name);
        static partial void InstanceFactory(ref TeamFoundationIdentityImpl instance, [CallerMemberName] string callerName = "");
        ...
        partial void RemoveProperty_PreCondition(ref ITeamFoundationIdentity instance, ref String name);
        partial void SetAttribute_PostValidate(ITeamFoundationIdentity instance, String name, String value);
        partial void SetAttribute_PreCondition(ref ITeamFoundationIdentity instance, ref String name, ref String value);
        partial void SetProperty_PostValidate(ITeamFoundationIdentity instance, String name, Object value);
        partial void SetProperty_PreCondition(ref ITeamFoundationIdentity instance, ref String name, ref Object value);
        ...
        partial void TryGetProperty_PreCondition(ref ITeamFoundationIdentity instance, ref String name, ref Object value);
