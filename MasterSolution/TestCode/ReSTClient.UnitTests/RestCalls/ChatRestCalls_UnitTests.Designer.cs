...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.RestCalls
{
    ...
    public partial class ChatRestCalls_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(ChatRestCalls instance, ref Object obj);

        partial void GetHashCode_PostValidate(ChatRestCalls instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(ChatRestCalls instance);
        ...
        partial void GetType_PreCondition(ChatRestCalls instance);
        ...
        partial void ToString_PreCondition(ChatRestCalls instance);
