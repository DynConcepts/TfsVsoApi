...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.RestCalls
{
    ...
    public partial class PackagingRestCalls_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(PackagingRestCalls instance, ref Object obj);
        partial void GetHashCode_PostValidate(PackagingRestCalls instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(PackagingRestCalls instance);
        ...
        partial void GetType_PreCondition(PackagingRestCalls instance);
        ...
        partial void ToString_PreCondition(PackagingRestCalls instance);
    }
}