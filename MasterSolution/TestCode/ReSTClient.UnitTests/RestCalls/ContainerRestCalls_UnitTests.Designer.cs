...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.RestCalls
{
    ...
    public partial class ContainerRestCalls_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(ContainerRestCalls instance, ref Object obj);
        partial void GetHashCode_PostValidate(ContainerRestCalls instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(ContainerRestCalls instance);
        ...
        partial void GetType_PreCondition(ContainerRestCalls instance);
        ...
        partial void ToString_PreCondition(ContainerRestCalls instance);
    }
}