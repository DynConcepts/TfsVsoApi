...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.Objects.Build
{
    ...
    public partial class JsonBuild_UnitTests : DynTestClassBase
    {
        ...
        partial void FromToken_PreCondition(JsonBuild instance, ref JToken token) { token = TestData; }
        ...
        private static JToken TestData
        {
            get
            {
                JObject jobject = CannedMessages.SampleBuilds;
