    ...
    public partial class JsonChangeSet_UnitTests : DynTestClassBase
    {
        ...
        public void FromToken_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance => { return _retVal = JsonChangeSet.FromToken(token); },
        ...
        partial void CaptureJson_PreCondition(JsonChangeSet instance, ref JToken token);
        ...
        partial void Equals_PreCondition(JsonChangeSet instance, ref Object obj);
        partial void FromToken_PostValidate(JsonChangeSet instance, JToken token, JsonChangeSet _retVal);
        partial void FromToken_PreCondition(JsonChangeSet instance, ref JToken token);
        partial void GetHashCode_PostValidate(JsonChangeSet instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(JsonChangeSet instance);
        ...
        partial void GetType_PreCondition(JsonChangeSet instance);
        ...
        partial void ToJSonString_PreCondition(JsonChangeSet instance);
        partial void ToString_PostValidate(JsonChangeSet instance, String _retVal);
        partial void ToString_PreCondition(JsonChangeSet instance);
