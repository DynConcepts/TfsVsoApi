    ...
    public partial class JsonArea_UnitTests : DynTestClassBase
    {
        ...
        public void FromToken_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance => { return _retVal = JsonArea.FromToken(content); },
        ...
        partial void CaptureJson_PreCondition(JsonArea instance, ref JToken token);
        ...
        partial void Equals_PreCondition(JsonArea instance, ref Object obj);
        partial void FromToken_PostValidate(JsonArea instance, JToken content, JsonArea _retVal);
        partial void FromToken_PreCondition(JsonArea instance, ref JToken content);

        partial void GetHashCode_PostValidate(JsonArea instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(JsonArea instance);
        ...
        partial void GetType_PreCondition(JsonArea instance);
        ...
        partial void ToJSonString_PreCondition(JsonArea instance);
        partial void ToString_PostValidate(JsonArea instance, String _retVal);
        partial void ToString_PreCondition(JsonArea instance);
