    ...
    public partial class JsonIteration_UnitTests : DynTestClassBase
    {
        ...
        public void FromToken_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance => { return _retVal = JsonIteration.FromToken(content); },
        ...
        partial void CaptureJson_PreCondition(JsonIteration instance, ref JToken token);
        ...
        partial void Equals_PreCondition(JsonIteration instance, ref Object obj);
        partial void FromToken_PostValidate(JsonIteration instance, JToken content, JsonIteration _retVal);
        partial void FromToken_PreCondition(JsonIteration instance, ref JToken content);

        partial void GetHashCode_PostValidate(JsonIteration instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(JsonIteration instance);
        ...
        partial void GetType_PreCondition(JsonIteration instance);
        ...
        partial void ToJSonString_PreCondition(JsonIteration instance);
        partial void ToString_PostValidate(JsonIteration instance, String _retVal);
        partial void ToString_PreCondition(JsonIteration instance);
