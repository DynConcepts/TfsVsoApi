...
namespace DynCon.OSI.VSO.ReSTClient.UnitTests.APIs
{
    ...
    public partial class IterationImpl_UnitTests : DynTestClassBase
    {
        ...
        partial void CaptureJson_PreCondition(IterationImpl instance, ref JToken token);
        ...
        partial void Equals_PreCondition(IterationImpl instance, ref Object obj);

        partial void GetHashCode_PostValidate(IterationImpl instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(IterationImpl instance);
        ...
        partial void GetType_PreCondition(IterationImpl instance);
        ...
        partial void ToJSonString_PreCondition(IterationImpl instance);
        partial void ToString_PostValidate(IterationImpl instance, String _retVal);
        partial void ToString_PreCondition(IterationImpl instance);
