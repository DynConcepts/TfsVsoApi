...
namespace DynCon.OSI.VSO.RestClient.ObjectModel_UnitTests.TFS.WorkItemTracking.Client
{
    ...
    public partial class QueryHierarchyImpl_UnitTests : DynTestClassBase
    {
        ...
        public void Find_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    Find_PreCondition(instance, ref id);
                },
        ...
        public void GetRefreshData_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQueryHierarchy) GetInstance(); },
                instance => { GetRefreshData_PreCondition(instance); },
        ...
        public void Reset_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQueryHierarchy) GetInstance(); },
                instance => { Reset_PreCondition(instance); },
        ...
        public void Save_UnitTest()
        {
            ExecuteMethod(
                () => { return (IQueryHierarchy) GetInstance(); },
                instance => { Save_PreCondition(instance); },
        ...
        partial void Find_PreCondition(IQueryHierarchy instance, ref Guid id);
        ...
        partial void GetRefreshData_PreCondition(IQueryHierarchy instance);
