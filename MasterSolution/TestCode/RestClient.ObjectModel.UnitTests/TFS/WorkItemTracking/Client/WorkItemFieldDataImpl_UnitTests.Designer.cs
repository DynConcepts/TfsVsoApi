...
namespace DynCon.OSI.VSO.RestClient.ObjectModel_UnitTests.TFS.WorkItemTracking.Client
{
    ...
    public partial class WorkItemFieldDataImpl_UnitTests : DynTestClassBase
    {
        ...
        public void GetFieldState_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    GetFieldState_PreCondition(instance, ref id);
                },
        ...
        public void GetUpdateFieldValue_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    GetUpdateFieldValue_PreCondition(instance, ref id, ref fu);
                },
        ...
        partial void GetFieldState_PreCondition(IWorkItemFieldData instance, ref Int32 id);
        ...
        partial void GetUpdateFieldValue_PreCondition(IWorkItemFieldData instance, ref Int32 id, ref IWorkItemFieldData_FieldUpdate fu);
