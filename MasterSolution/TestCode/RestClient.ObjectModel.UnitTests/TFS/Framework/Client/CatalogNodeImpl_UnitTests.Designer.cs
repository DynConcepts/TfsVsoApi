...
using DynCon.OSI.VSO.RestClient.ObjectModel_UnitTests.TFS.Framework.Common;
...
namespace DynCon.OSI.VSO.RestClient.ObjectModel_UnitTests.TFS.Framework.Client
{
    ...
    public partial class CatalogNodeImpl_UnitTests : DynTestClassBase
    {
        ...
        public void CreateChild_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    CreateChild_PreCondition(instance, ref resourceTypeIdentifier, ref resourceDisplayName);
                },
        ...
        public void ExpandDependencies_UnitTest()
        {
            ExecuteMethod(
                () => { return (ICatalogNode) GetInstance(); },
                instance => { ExpandDependencies_PreCondition(instance); },
        ...
        internal static IEnumerable<CatalogNodeImpl> GetIEnumerableInstance() { return new List<CatalogNodeImpl> {GetInstance()}; }

        internal static CatalogNodeImpl GetInstance([CallerMemberName] string callerName = "")
        {
            var instance = new CatalogNodeImpl();
            InstanceFactory(ref instance, callerName);
            return instance;
        }

        static partial void InstanceFactory(ref CatalogNodeImpl instance, [CallerMemberName] string callerName = "");
