    ...
    public partial class TfsRequestSettingsImpl_UnitTests : DynTestClassBase
    {
        ...
        public void Clone_UnitTest()
        {
            ExecuteMethod(
                ...
                instance => { Clone_PreCondition(instance); },
        ...
        partial void Clone_PreCondition(ITfsRequestSettings instance);
        ...
        internal static IEnumerable<TfsRequestSettingsImpl> GetIEnumerableInstance() { return new List<TfsRequestSettingsImpl> {GetInstance()}; }

        internal static TfsRequestSettingsImpl GetInstance([CallerMemberName] string callerName = "")
        {
            var instance = new TfsRequestSettingsImpl();
            InstanceFactory(ref instance, callerName);
            return instance;
        }

        static partial void InstanceFactory(ref TfsRequestSettingsImpl instance, [CallerMemberName] string callerName = "");
