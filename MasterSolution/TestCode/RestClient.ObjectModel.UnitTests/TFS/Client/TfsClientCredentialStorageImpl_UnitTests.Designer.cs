    ...
    public partial class TfsClientCredentialStorageImpl_UnitTests : DynTestClassBase
    {
        ...
        public void GetTokenProperty_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    GetTokenProperty_PreCondition(instance, ref serverUrls, ref propertyName);
                },
        ...
        public void RemoveTokenValuesByUser_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                instance =>
                {
                    ...
                    RemoveTokenValuesByUser_PreCondition(instance, ref userId);
                },
        ...
        public void RemoveToken_UnitTest()
        {
            ...
            ExecuteMethod(
                ...
                {
                    serverUrl = default(Uri); //No Type
                    RemoveToken_PreCondition(instance, ref serverUrl);
                },
        ...
        partial void GetTokenProperty_PreCondition(ITfsClientCredentialStorage instance, ref Uri[] serverUrls, ref String propertyName);
        ...
        partial void RemoveTokenValuesByUser_PreCondition(ITfsClientCredentialStorage instance, ref Guid userId);
        partial void RemoveToken_PostValidate(ITfsClientCredentialStorage instance, Uri serverUrl);
        partial void RemoveToken_PreCondition(ITfsClientCredentialStorage instance, ref Uri serverUrl);
