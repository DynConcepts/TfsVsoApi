...
namespace DynCon.OSI.Core_UnitTests.Helpers
{
    ...
    public partial class ToBeImplementedException_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(ref ToBeImplementedException instance, ref Object obj);
        partial void GetBaseException_PostValidate(ref ToBeImplementedException instance, Exception _retVal);
        partial void GetBaseException_PreCondition(ref ToBeImplementedException instance);
        partial void GetHashCode_PostValidate(ref ToBeImplementedException instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(ref ToBeImplementedException instance);
        ...
        partial void GetObjectData_PreCondition(ref ToBeImplementedException instance, ref SerializationInfo info, ref StreamingContext context);
        partial void GetType_PostValidate(ref ToBeImplementedException instance, Type _retVal);
        partial void GetType_PreCondition(ref ToBeImplementedException instance);
        ...
        partial void ToString_PreCondition(ref ToBeImplementedException instance);
    }
}