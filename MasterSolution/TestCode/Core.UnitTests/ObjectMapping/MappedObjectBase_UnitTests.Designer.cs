...
namespace DynCon.OSI.Core.ObjectMapping
{
    ...
    public partial class MappedObjectBase_UnitTests : DynTestClassBase
    {
        ...
        partial void Equals_PreCondition(MappedObjectBase instance, ref Object obj);

        partial void GetHashCode_PostValidate(ref MappedObjectBase instance, Int32 _retVal);
        partial void GetHashCode_PreCondition(MappedObjectBase instance);
        ...
        partial void GetType_PreCondition(MappedObjectBase instance);
        ...
        partial void ToString_PreCondition(MappedObjectBase instance);
    }
}