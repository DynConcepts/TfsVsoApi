...
namespace DynCon.OSI.VSO.ReSTClient.Objects.TFVC
{
    ...
    /// Class JsonShelveSet.
    /// </summary>
    internal class JsonShelveSetChange : JsonBackedObjectBase
    {
        /// <summary>
        /// Froms the token.
        /// </summary>
        /// <param name="token">The token.</param>
        /// <returns>JsonShelveSetChange.</returns>
        public static JsonShelveSetChange FromToken(JToken token)
        {
            var instance = new JsonShelveSetChange(token);
            return instance;
        }
        ...
        public JsonShelveSetChange(JToken json)
            : base(json) { }
