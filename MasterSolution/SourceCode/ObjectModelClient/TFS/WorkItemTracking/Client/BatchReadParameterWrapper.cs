...
namespace DynCon.OSI.VSO.ObjectModelClient.TFS.WorkItemTracking.Client
{
    internal class BatchReadParameterWrapper : BatchReadParameterWrapper<IBatchReadParameter, BatchReadParameter>, IBatchReadParameter
    {
        ...
        internal static void SetMapper() { Mapper = new ObjectMapper<IBatchReadParameter, BatchReadParameter>(src => ((BatchReadParameterWrapper) src).r_Instance, src => new BatchReadParameterWrapper(src)); }
    }
