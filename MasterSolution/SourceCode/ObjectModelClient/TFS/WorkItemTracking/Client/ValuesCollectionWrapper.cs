...
namespace DynCon.OSI.VSO.ObjectModelClient.TFS.WorkItemTracking.Client
{
    internal class ValuesCollectionWrapper : ValuesCollectionWrapper<IValuesCollection, ValuesCollection>, IValuesCollection
    {
        ...
        internal static void SetMapper() { Mapper = new ObjectMapper<IValuesCollection, ValuesCollection>(src => ((ValuesCollectionWrapper) src).r_Instance, src => new ValuesCollectionWrapper(src)); }
    }
