...
namespace DynCon.OSI.VSO.ObjectModelClient.TFS.WorkItemTracking.Client
{
    internal class FieldDefinitionWrapper : FieldDefinitionWrapper<IFieldDefinition, FieldDefinition>, IFieldDefinition
    {
        ...
        internal static void SetMapper() { Mapper = new ObjectMapper<IFieldDefinition, FieldDefinition>(src => ((FieldDefinitionWrapper) src).r_Instance, src => new FieldDefinitionWrapper(src)); }
    }
