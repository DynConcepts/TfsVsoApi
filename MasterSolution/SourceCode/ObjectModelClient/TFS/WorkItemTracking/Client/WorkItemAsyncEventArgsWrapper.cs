...
namespace DynCon.OSI.VSO.ObjectModelClient.TFS.WorkItemTracking.Client
{
    internal class WorkItemAsyncEventArgsWrapper : WorkItemAsyncEventArgsWrapper<IWorkItemAsyncEventArgs, WorkItemAsyncEventArgs>, IWorkItemAsyncEventArgs
    {
        ...
        internal static void SetMapper() { Mapper = new ObjectMapper<IWorkItemAsyncEventArgs, WorkItemAsyncEventArgs>(src => ((WorkItemAsyncEventArgsWrapper) src).r_Instance, src => new WorkItemAsyncEventArgsWrapper(src)); }
    }
