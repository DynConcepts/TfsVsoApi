...
namespace DynCon.OSI.VSO.ObjectModelClient.TFS.WorkItemTracking.Client
{
    internal class CategoryCollectionWrapper : CategoryCollectionWrapper<ICategoryCollection, CategoryCollection>, ICategoryCollection, IEnumerable
    {
        ...
        internal static void SetMapper() { Mapper = new ObjectMapper<ICategoryCollection, CategoryCollection>(src => ((CategoryCollectionWrapper) src).r_Instance, src => new CategoryCollectionWrapper(src)); }
    }
