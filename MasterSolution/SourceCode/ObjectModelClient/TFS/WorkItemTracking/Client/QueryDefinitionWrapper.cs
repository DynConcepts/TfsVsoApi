...
namespace DynCon.OSI.VSO.ObjectModelClient.TFS.WorkItemTracking.Client
{
    internal class QueryDefinitionWrapper : QueryDefinitionWrapper<IQueryDefinition, QueryDefinition>, IQueryDefinition
    {
        ...
        internal static void SetMapper() { Mapper = new ObjectMapper<IQueryDefinition, QueryDefinition>(src => ((QueryDefinitionWrapper) src).r_Instance, src => new QueryDefinitionWrapper(src)); }
    }
